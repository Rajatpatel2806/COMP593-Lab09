...
lbl_weight_val.grid(row=1, column=1, padx = (0,10), pady = (10,5), sticky=W)
...
lbl_type_val.grid(row=2, column=1, padx = (0,10), pady = (10,5), sticky=W)
...
bar_special_attack = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGHT, maximum=STATE_MAX_VALUE)
...
bar_special_defense = ttk.Progressbar(frm_stats, length=PRG_BAR_LENGHT, maximum=STATE_MAX_VALUE)
